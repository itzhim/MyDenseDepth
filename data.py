...
def get_nyu_data(batch_size, nyu_data_zipfile='/content/drive/MyDrive/nyu_data.zip'):
    ...
    #nyu2_train = nyu2_train[:50000]
    #nyu2_test = nyu2_test[:50000]
...
class NYU_BasicAugmentRGBSequence(Sequence):
    ...
    def __getitem__(self, idx, is_apply_policy=True):
        ...
        for i in range(batch_x.shape[0]):
            ...
            y = np.clip(np.asarray(Image.open( "/content/"+sample[1] )).reshape(480,640,1)/255*self.maxDepth,0,self.maxDepth)
